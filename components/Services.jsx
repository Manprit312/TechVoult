import { Code2, Smartphone, Blocks, Gamepad2, Megaphone, Search, MonitorPlay, Brain } from "lucide-react";
          ...
          {services.map((service, idx) => (
            <div
              ...
              className="relative p-6 rounded-xl bg-white border border-gray-200 shadow-sm transition-all duration-500 z-0 
                         hover:-translate-y-3 hover:shadow-2xl hover:z-12 hover:border-gray-300"
            >
              {service.icon}
