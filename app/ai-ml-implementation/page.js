...
export default function AIMLImplementationPage() {
  /* ====== content (paste exact text where marked) ====== */
  const hero = {
    title: "AI & ML Development Services", // TODO: paste exact title
    subtitle:
      "Build, implement and scale AI/ML solutions that drive measurable business impact.", // TODO
  };

  const overview = {
    title:
      "Accelerate business outcomes with AI/ML implementation", // TODO
    points: [
      "End-to-end consulting to deployment", // TODO
      "Model development, training & optimization", // TODO
      "Systems integration & MLOps", // TODO
      "Security & governance best practices", // TODO
    ],
  };
  ...
  const services = [
    {
      ...
      text: "Assess, discover and prioritize high-value AI/ML use cases.", // TODO
    },
    {
      icon: Cpu,
      title: "ML Model Development",
      text: "Data prep, feature engineering, training, evaluation, and tuning.", // TODO
    },
    {
      icon: Bot,
      title: "Generative AI & Chatbots",
      text: "RAG, LLM orchestration, prompt engineering, safety & guardrails.", // TODO
    },
    {
      icon: LineChart,
      title: "Predictive Analytics",
      text: "Forecasting, churn, propensity, recommendations and more.", // TODO
    },
    {
      icon: ImageIcon,
      title: "Computer Vision",
      text: "Detection, classification, OCR, quality inspection, and AR/VR.", // TODO
    },
    {
      icon: Database,
      title: "MLOps & DataOps",
      text: "Pipelines, CI/CD for models, monitoring, observability, governance.", // TODO
    },
  ];

  const useCases = [
    // TODO: replace texts to exact items from screenshot.
  ...
  const engagement = [
    // Flexible engagement models cards
    {
      title: "Dedicated Team",
      text: "Augment with our certified AI/ML engineers and data scientists.", // TODO
    },
    {
      title: "Fixed Scope",
      text: "Define scope & milestones; we deliver end-to-end.", // TODO
    },
    {
      title: "Time & Material",
      text: "Iterate quickly with agile, transparent delivery.", // TODO
    },
  ];
  ...
  const whyUs = [
    {
      ...
      text: "Role-based access, encryption, PII protection, audit trails.", // TODO
    },
    {
      icon: BadgeCheck,
      title: "Battle-tested Playbooks",
      text: "Proven delivery patterns, reference architectures & accelerators.", // TODO
    },
    {
      icon: Rocket,
      title: "Faster Time-to-Value",
      text: "From PoC to production with a focus on measurable ROI.", // TODO
    },
  ];

  const portfolioSlides = [
    // TODO: replace with your portfolio snippets
  ...
  const testimonials = [
    {
      quote:
        "Their AI/ML delivery was flawless. We went from idea to production in weeks.",
      name: "VP Engineering",
      org: "Global Retailer",
    },
    {
      quote:
        "Quality, speed, and documentation were outstanding. Highly recommended.",
      name: "Head of Data",
      org: "FinTech Unicorn",
    },
    {
      quote:
        "Best partner we’ve worked with for MLOps and governance. True experts.",
      name: "CTO",
      org: "Healthcare ISV",
    },
  ];
  ...
  const faqs = [
    {
      q: "How do you start an AI/ML engagement?",
      a: "We run a discovery sprint to align on outcomes, data readiness, and quick-win use cases.",
    },
    {
      q: "Do you provide MLOps?",
      a: "Yes. We set up experimentation tracking, CI/CD for models, monitoring, drift alerts, and governance.",
    },
    {
      q: "What about security & compliance?",
      a: "We follow enterprise best practices for security, access controls, PII protection, and audit logging.",
    },
    {
      q: "Can you work with our internal team?",
      a: "Absolutely. We can augment your team or deliver independently — your choice.",
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 text-gray-800 mt-16">
      {/* HERO */}
      <section className="py-16 md:py-20 bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center px-6">
          <motion.div {...fade()}>
            <h1 className="text-4xl md:text-5xl font-extrabold">{hero.title}</h1>
          ...
          <motion.form
            {...fade(0.1)}
            className="bg-white shadow-xl rounded-2xl p-6 space-y-3"
          ...
          >
            ...
            <button className="w-full px-5 py-3 rounded-lg font-semibold text-white bg-gradient-to-r from-indigo-500 to-purple-600">
              Get Started
            </button>
          </motion.form>
        </div>
      ...
      <section className="py-16 bg-white/70">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div {...fade(0.1)} className="h-60 rounded-xl bg-gray-200 border flex items-center justify-center">
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6">
          <motion.h3 {...fade()} className="text-3xl font-bold text-center">
            AI & ML Services for Every Stage of the Model Lifecycle
          </motion.h3>
      ...
      {/* TOP USE CASES SLIDER */}
      <section className="py-16 bg-white/60">
        <div className="max-w-6xl mx-auto px-6">
          <motion.h3 {...fade()} className="text-3xl font-bold text-center">
            Top AI/ML Use Cases Driving Business Innovation
          </motion.h3>
          <Swiper
      ...
      {/* CTA STRIP */}
      <section className="py-10 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row gap-6 items-center justify-between">
          <motion.h4 {...fade()} className="text-2xl font-bold">
            Ready to unlock ROI with AI?
          </motion.h4>
          <a
            href="#contact"
            className="px-6 py-3 bg-white/10 hover:bg-white/20 rounded-xl backdrop-blur font-semibold"
          >
            Schedule a Call
          </a>
        </div>
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {engagement.map((e, i) => (
              <motion.div
                key={i}
                {...fade(i * 0.05)}
                className="bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm p-6"
              >
          ...
          <div className="mt-10 grid md:grid-cols-5 gap-6">
            {process.map((p, i) => (
              <motion.div
                key={i}
                {...fade(i * 0.05)}
                className="bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm p-6 text-center"
              >
                <div className="h-10 w-10 mx-auto rounded-full bg-indigo-100 text-indigo-700 flex items-center justify-center font-bold">
                  {i + 1}
                </div>
      ...
      <section className="py-16 bg-white/70">
        <div className="max-w-6xl mx-auto px-6">
          <motion.h3 {...fade()} className="text-3xl font-bold text-center">
            Core AI & ML Technologies We Specialize In
          </motion.h3>
          <div className="mt-10 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
            {tech.map((t, i) => (
              <motion.div
                key={i}
                {...fade(i * 0.03)}
                className="h-16 rounded-xl bg-white ring-1 ring-gray-200 shadow-sm flex items-center justify-center text-sm font-medium"
              >
                {t}
              </motion.div>
            ))}
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6">
          <motion.h3 {...fade()} className="text-3xl font-bold text-center">
            Why Choose Us for Your AI/ML Development Needs
          </motion.h3>
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {whyUs.map((w, i) => (
              <motion.div
                ...
                className="bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm p-6"
              >
                <w.icon className="h-7 w-7 text-indigo-600" />
      ...
      <section className="py-16 bg-white/60">
        <div className="max-w-6xl mx-auto px-6">
          <motion.h3 {...fade()} className="text-3xl font-bold text-center">
            Portfolio: Innovations with AI/ML Across Domains & Industries
          </motion.h3>
          <Swiper
            modules={[Autoplay, Pagination]}
            autoplay={{ delay: 2600 }}
