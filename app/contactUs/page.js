    ...
    <div className="rounded-2xl bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 py-30 px-8 pt-7 shadow-sm ring-1 ring-gray-200 text-gray-800 h-fit">
      ...
      <div className="mt-6 space-y-2 text-gray-700 text-sm">
        <p className="flex items-center gap-2">
          <Mail className="h-5 w-5 text-indigo-500" /> sales@sdlccorp.com
        </p>
        <p className="flex items-center gap-2">
    ...
    {/* Form block */}
       <form onSubmit={onSubmit} className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-8 rounded-2xl shadow-sm ring-1 ring-gray-200">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1">
                <label className="text-sm font-medium text-gray-700" htmlFor="countryCode">Country Code</label>
                <input id="countryCode" name="countryCode" placeholder="+1" className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400" />
              </div>
              <div className="space-y-1">
                <label className="text-sm font-medium text-gray-700" htmlFor="phone">Phone *</label>
                <input id="phone" name="phone" required placeholder="(512) 123-4567" className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400" />
              </div>
