...
export default function WordPressPage() {
  ...
  const features = [
    { title: "Custom WordPress Design", desc: "Tailored UI that reflects your brand guidelines and improves engagement." },
    { title: "Responsive & Mobile-First", desc: "Fluid layouts that look perfect across phones, tablets, and desktops." },
    { title: "SEO-Ready Architecture", desc: "Semantic markup, fast loads, and structured data for higher rankings." },
    { title: "Secure & Scalable", desc: "Hardened install, roles & permissions, backups, and CDN-ready builds." },
  ];

  const otherServices = [
    { title: "WordPress Speed Optimization", desc: "Core Web Vitals improvements using caching, image optimization, and code-splitting." },
    { title: "Headless WordPress", desc: "Next.js frontends on top of WP REST API/GraphQL for app-like experiences." },
    { title: "Multilingual & Multisite", desc: "Global sites with WPML/Polylang and scalable multisite architectures." },
  ];
  ...
  const portfolio = [
    { title: "Wellness – Coaching Platform (LMS)", img: "/assets/images/wordpressport2.jpeg", summary: "Custom course types, Stripe subscriptions, lesson progress, and student dashboards." },
    { title: "Corporate WordPress Website", img: "/assets/images/wordpressport3.jpeg", summary: "Component-driven pages with Gutenberg blocks, careers, locations, and blog." },
    { title: "WooCommerce Storefront", img: "/assets/images/prestaport.jpeg", summary: "Conversion-focused PDPs, one-page checkout, and shipping/payment integrations." },
  ];

  const caseStudies = [
    { title: "B2B Portal Revamp", img: "/assets/images/b2brewamp.jpeg", result: "Modernized UX reduced support tickets by 38% and increased lead MQLs by 27%." },
    { title: "Publisher’s Blog Migration", img: "/assets/images/publisherblog.jpeg", result: "Seamless migration (1000+ posts), 0 downtime, improved SERP visibility." },
    { title: "Nonprofit Fundraising", img: "/assets/images/fundraising.jpeg", result: "Donations UX uplift led to +54% conversions during seasonal campaigns." },
  ];

  const hostingPlans = [
    { title: "Managed Hosting", points: ["Daily backups", "Staging", "WAF / Firewall", "99.9% uptime"] },
    { title: "Redesign & Revamp", points: ["UX audit", "Design system", "Gutenberg blocks", "A/B tests"] },
    { title: "Ongoing Maintenance", points: ["Core & plugin updates", "Security monitoring", "Performance upkeep", "Monthly reports"] },
  ];

  const workflow = [
    { step: "1. Discovery", desc: "Workshops to map goals, users, content, and integrations. Clear scope & backlog." },
    { step: "2. Design & Architecture", desc: "IA, wireframes, design system, and scalable WP architecture planned for growth." },
    { step: "3. Development", desc: "Block-based pages, custom post types, plugins, and REST/GraphQL integrations." },
    { step: "4. QA & Launch", desc: "Accessibility & cross-browser QA, performance hardening, and guided rollout." },
  ];

  const testimonials = [
    { name: "Mark Wilson", org: "Marketing Lead", quote: "Our custom WordPress site boosted engagement by 40% in the first quarter." },
    { name: "Steve Thomas", org: "CTO", quote: "Plugin development and API work were flawless — shipped on time and budget." },
    { name: "David Miller", org: "Founder", quote: "Maintenance & support have been rock-solid. The team is responsive and proactive." },
  ];

  const faqs = [
    { q: "Do you build custom WordPress themes?", a: "Yes. We design and code bespoke themes (Gutenberg/ACF/Blocks) optimized for speed and SEO." },
    { q: "Can you migrate my site to WordPress?", a: "Absolutely. We migrate from any CMS with redirects, content cleanup, and data integrity checks." },
    { q: "Do you support WooCommerce?", a: "Yes. We implement product setups, payments, shipping, tax, and conversion-focused UX." },
    { q: "Do you offer post-launch maintenance?", a: "Yes. Managed hosting, updates, security, and performance monitoring are available." },
  ];

  /* --------------------------------- UI -------------------------------- */
  return (
    <main className="text-gray-800 bg-gradient-to-br from-blue-50 via-indigo-50 to-white mt-18">
      
      {/* HERO */}
      <section className="py-20 px-6 bg-gradient-to-r from-blue-100 via-indigo-100 to-blue-50">
        <div className="mx-auto max-w-6xl grid gap-10 md:grid-cols-2 items-center">
          <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <h1 className="text-4xl font-extrabold">WordPress Development Services</h1>
            <p className="mt-3 text-gray-700">
              Custom WordPress design, plugins, WooCommerce, migrations, and maintenance — built for speed, SEO, and scale.
            </p>
            <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7 }} className="mt-6 h-48 w-full overflow-hidden rounded-xl shadow-lg">
              <Image src="/assets/images/wordpressport1.jpeg" alt="WordPress Hero" width={600} height={300} className="h-full w-full object-cover" />
            </motion.div>
          </motion.div>
          ...
          <motion.form onSubmit={onSubmit} className="bg-white p-6 rounded-2xl shadow-xl space-y-4" initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.12 }}>
            ...
            <button type="submit" className="w-full rounded-lg bg-gradient-to-r from-blue-500 to-indigo-500 py-3 text-white font-semibold hover:opacity-95">Get Free Consultation</button>
            {status && <p className="text-sm text-indigo-700 bg-indigo-50 border border-indigo-100 rounded-lg px-3 py-2">{status}</p>}
          </motion.form>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-6xl grid gap-10 md:grid-cols-2 px-6 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="h-48 overflow-hidden rounded-xl shadow-lg">
            <Image src="/assets/images/overviewwordpress.jpeg" alt="WordPress Overview" width={500} height={250} className="h-full w-full object-cover" />
          </motion.div>
          <div>
            <h2 className="text-3xl font-bold">Overview of WordPress Development Services</h2>
            <p className="mt-4 text-gray-700">We design, build, and maintain WordPress websites with enterprise attention to performance and security...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-6xl px-6">
          <h3 className="text-3xl font-bold text-center">WordPress Development Portfolio</h3>
          <Swiper slidesPerView={1.15} spaceBetween={16} breakpoints={{ 768: { slidesPerView: 2 }, 1024: { slidesPerView: 3 } }} className="mt-10">
            {portfolio.map((p, i) => (
              <SwiperSlide key={i}>
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: i * 0.1 }} className="rounded-2xl overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-white shadow">
      ...
      <section className="py-16">
        <div className="mx-auto max-w-6xl px-6">
          <h3 className="text-3xl font-bold text-center">Case Studies on Successful WordPress Projects</h3>
          <Swiper slidesPerView={1.15} spaceBetween={16} breakpoints={{ 768: { slidesPerView: 2 }, 1024: { slidesPerView: 3 } }} className="mt-10">
            {caseStudies.map((c, i) => (
              <SwiperSlide key={i}>
